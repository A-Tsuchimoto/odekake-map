...
元は手作りのExcel台帳2つ。関東は `高田駅_家族お出かけスポット統合_座標追加.xlsx`、
沖縄は `沖縄本島_県庁前発 家族お出かけスポット統合管理`。
カテゴリ名は台帳ごとに表記が違ったので、11分類に揃えてある
（例: 科学館系／科学館・博物館 → 科学館・博物館）。

所要時間は休日昼間の概算で、渋滞や乗換で変動する。沖縄の公共交通は路線バス中心で
本数が少ない路線が多い。Google Maps評価は関東分のみ（2026-07-26時点の参考値）で、
沖縄分は未確認のため入れていない。
