...
| 沖縄 okinawa | 県庁前駅 | 150 | 1 | 1 | 34 |
| 北海道 hokkaido | 札幌駅 | 141 | 0 | 128 | 64 |
| 小田原 odawara | 小田原駅 | 93 | 1 | 84 | 69 |
| 名古屋 nagoya | 名古屋駅 | 86 | 2 | 72 | 53 |
...
検索の「二郎系」で全部引ける。**新しく開いた4店は座標が取れず地図なし**
（この環境からは地図APIに出られない）。分かり次第 `import-spots-json.py` で上書きする。
